        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute left-0 right-0 mt-2 bg-white dark:bg-zinc-900 border border-stone-200 dark:border-zinc-800 p-1.5 rounded-3xl shadow-xl overflow-hidden z-10"
            >
