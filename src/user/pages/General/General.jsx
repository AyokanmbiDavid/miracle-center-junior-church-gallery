...
export default function General() {
  return (
    <div className="p-6 max-w-7xl mx-auto bg-stone-50 dark:bg-zinc-950 min-h-screen pb-20 text-stone-800 dark:text-zinc-100 font-sans transition-colors duration-300">
