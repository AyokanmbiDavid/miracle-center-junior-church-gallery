...
export default function General() {
  return (
    <div className="p-6 w-dvw overflow-y-auto mx-auto bg-stone-50 dark:bg-gray-900 h-dvh text-stone-800 dark:text-zinc-100 transition-colors duration-300">
            ...
            <div className="p-4 flex flex-col absolute w-full bottom-0 gap-2 bg-gradient-to-t from-stone-950 via-stone-950/85 to-transparent border-t border-stone-900/10 backdrop-blur-xs">
              <div className="flex w-full items-center justify-between gap-3">
                <div className="flex flex-col min-w-0">
                  ...
                  <p className="text-[10px] text-zinc-400 flex items-center gap-1 mt-0.5 uppercase tracking-wider">
                ...
                <Link
                  to={`/classes/${item.id}`}
                  className="flex items-center gap-1 px-3 py-2 text-[10px] font-bold bg-white hover:bg-stone-50 text-stone-900 border border-stone-200 rounded-full transition-all shadow-xs active:scale-95"
