...
import { Baby, Smiley, User, CaretDown, Check, UsersIcon, ChalkboardTeacher } from '@phosphor-icons/react';
import { UserPlus2 } from 'lucide-react';

const ageGroups = [
  { id: 'All', label: 'All class', icon: UsersIcon },
  { id: 'toddlers', label: 'Toddlers', icon: Baby },
  { id: 'children', label: 'Children', icon: Smiley },
  { id: 'preteens', label: 'Pre-teens', icon: User },
  { id: 'teenagers', label: 'Teenagers', icon: UserPlus2 },
];
