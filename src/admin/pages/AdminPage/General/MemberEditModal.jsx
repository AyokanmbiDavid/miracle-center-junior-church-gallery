        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-xs font-medium">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-full p-2.5 bg-stone-50 dark:bg-zinc-950 border border-stone-200 dark:border-zinc-800 rounded-lg text-stone-800 dark:text-zinc-100 placeholder-stone-400 dark:placeholder-zinc-600 focus:outline-none focus:border-amber-600 dark:focus:border-amber-500"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className="w-full p-2.5 bg-stone-50 dark:bg-zinc-950 border border-stone-200 dark:border-zinc-800 rounded-lg text-stone-800 dark:text-zinc-100 focus:outline-none focus:border-amber-600 dark:focus:border-amber-500 font-mono text-[11px]"
            >
