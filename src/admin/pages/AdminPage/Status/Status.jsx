...
export default function Status() {
  ...
  return (
    <div className="p-3 max-w-7xl relative  mx-auto dark:bg-zinc-950 min-h-screen text-stone-800 dark:text-zinc-100 transition-colors duration-300">
      <div className="flex flex-col sticky z-20 top-0 md:flex-row justify-between items-start md:items-center gap-4 mb-8 pb-6 border-b border-stone-200 dark:border-zinc-900">
        <div>
        ...
        <div className="flex max-sm:flex-col items-center gap-3 max-md:w-full">
          <div className="relative flex-1 md:w-64 max-sm:w-full">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-3 text-xs bg-white dark:bg-zinc-900 border border-stone-200 dark:border-zinc-800 rounded-full text-stone-800 dark:text-zinc-100 focus:outline-none focus:border-amber-600"
            />
          </div>
          <button type="button" onClick={() => setIsCreateOpen(true)} className="flex max-sm:w-full items-center gap-1.5 px-4 py-3 text-xs font-semibold text-white bg-amber-600 hover:bg-amber-700 rounded-full cursor-pointer">
