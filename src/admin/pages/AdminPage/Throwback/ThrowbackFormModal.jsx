        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-xs font-medium">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              rows={3}
              className="w-full p-2.5 bg-stone-50 dark:bg-zinc-950 border border-stone-200 dark:border-zinc-800 rounded-2xl text-stone-800 dark:text-zinc-100 placeholder-stone-400 dark:placeholder-zinc-600 focus:outline-none focus:border-amber-600 dark:focus:border-amber-500 font-sans resize-none"
          ...
          <div className="flex justify-end gap-2 mt-4 pt-4 border-t border-stone-100 dark:border-zinc-800">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-3 flex items-center justify-center gap-1.5 bg-amber-600 hover:bg-amber-700 dark:bg-amber-600 dark:hover:bg-amber-700 text-white rounded-full font-mono font-bold shadow-md shadow-amber-700/10 transition-colors cursor-pointer disabled:bg-stone-400 dark:disabled:bg-zinc-800"
            >
              {loading ? (
                <>
                  <span>Archiving...</span>
