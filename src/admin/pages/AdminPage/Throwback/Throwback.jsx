...
export default function Throwback() {
  ...
  return (
    <div className="p-3 max-w-7xl relative mx-auto bg-stone-50 dark:bg-zinc-950 text-stone-800 dark:text-zinc-100 antialiased transition-colors duration-300">
      
      {/* Action Bar & Controls Panel Header */}
      <div className="flex flex-col sticky top-0 z-20 md:flex-row justify-between items-start md:items-center gap-4 mb-6 pb-6 border-b border-stone-200 dark:border-zinc-900">
        <div>
        ...
        <div className="flex items-center max-md:flex-col max-md:items-stretch gap-3 w-full md:w-auto">
          ...
          <div className="relative flex-1 md:w-64">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-3 text-xs bg-white dark:bg-zinc-900 border border-stone-200 dark:border-zinc-800 rounded-full text-stone-800 dark:text-zinc-100 placeholder-stone-400 dark:placeholder-zinc-600 focus:outline-none focus:border-amber-600 dark:focus:border-amber-500 transition-colors "
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 px-4 py-3 text-xs font-semibold text-white bg-amber-600 hover:bg-amber-700 dark:bg-amber-600 dark:hover:bg-amber-700 rounded-full transition-colors cursor-pointer shadow-md shadow-amber-700/10 active:scale-98"
          >
